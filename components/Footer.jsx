        ...
        <div className="flex flex-col md:flex-row justify-between py-16 md:py-24">
            ...
            <div className="mb-7 md:mb-0">
                ...
                <ul className="text-dimGray text-[10px] md:text-[15px]">
                    <li className="mb-2 md:mb-[14px] cursor-pointer hover:underline">About Us</li>
                    <li className="mb-2 md:mb-[14px] cursor-pointer hover:underline">Products</li>
            ...
            <div className="flex flex-col items-center lg:hidden">
                ...
                <div className="text-primaryBlue w-24 flex justify-between">
                    ...
                    <BsFacebook className="cursor-pointer" size={12} />
                </div>
            </div>
        </div>
    </footer>
