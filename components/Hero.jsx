    ...
    <div className="pt-[500px] pb-[68px] md:pl-20 md:flex md:pt-0">
        <div className="md:flex flex-col items-start md:w-1/2">
            ...
            <div className={`${source.className} px-12 md:px-0 text-center md:text-left md:pt-24 md:w-[345px]`}>
                ...
                <p className="text-xs md:text-[16px] text-bodyBlack pt-5 md:pt-6 pb-8 md:pb-10 md:leading-[24px]">Naturally made Healthcare Products for the better care & support of your body.</p>
                <Link href="#articles">
                    <button className={`w-[120px] md:w-[190px] h-[40px] md:h-[63px] ${openSans.className} text-white text-[12px] md:text-[18px] font-bold tracking-wider bg-jasper rounded-full hover:bg-[#c42b38] duration-200`}>
                        Explore Now!
                    </button>
                </Link>
            </div>
