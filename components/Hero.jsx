    ...
    <div className="flex">
        <div className="flex flex-col items-start w-1/2">
            ...
            <div className={`${source.className} pt-24 w-[345px]`}>
                ...
                <p className="text-bodyBlack pt-6 pb-10">Naturally made Healthcare Products for the better care & support of your body.</p>
                <button className={`w-[190px] h-[63px] ${openSans.className} font-bold tracking-wider bg-jasper rounded-full hover:bg-[#c42b38] duration-200`}>Explore Now!</button>
            </div>
        </div>
        ...
        <div>
            <button className={`${source.className} font-[600] absolute top-5 right-5 w-[122px] h-[42px] border-1 border-white rounded-full text-white hover:bg-[#c42b38] duration-200`}>Get in Touch</button>
        </div>
    </div>
  )
}
